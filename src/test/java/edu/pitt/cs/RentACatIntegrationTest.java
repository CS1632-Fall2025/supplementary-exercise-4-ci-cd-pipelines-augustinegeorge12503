...
public class RentACatIntegrationTest {
	...
	public void testRentCatFailureNumCats3() {
		...
		// Precondition: rent once
		assertTrue(r.rentCat(2));
		assertTrue(c2.getRented());
		out.reset(); // clear previous message
	...
	public void testReturnCatNumCats3() {
		...
		// Precondition: rent c2
		assertTrue(r.rentCat(2));
		assertTrue(c2.getRented());
		out.reset(); // clear precondition output
	...
	public void testReturnFailureCatNumCats3() {
		...
		assertFalse(c2.getRented()); // ensure not rented
		boolean ok = r.returnCat(2);
		assertFalse(ok);
		assertFalse(c2.getRented());

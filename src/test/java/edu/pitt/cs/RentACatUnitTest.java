...
public class RentACatUnitTest {
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse(result);
		// c2 not added to r, so renameCat must not be called on it
	...
	public void testRentCatNumCats3() {
		...
		// Ensure available by default (mock is available unless overridden)
	...
	public void testReturnCatNumCats3() {
		...
		// Pretend c2 is currently rented
		when(c2.getRented()).thenReturn(true);
